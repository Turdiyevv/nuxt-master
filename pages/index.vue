...
<template>
  ...
  <section>
    ...
    <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
      <div class="w-16 h-16 bg-blue-500 dark:bg-blue-800 rounded-full
                flex items-center justify-center">
        <Icon name="material-symbols:file-copy" class="text-white text-4xl"/>
      </div>
      <div class="
        flex-1 h-2 bg-gradient-to-r from-blue-500 dark:from-blue-800
        to-gray-500 dark:to-gray-800"
      >
      </div>
      <div class="w-16 h-16 bg-gray-500 dark:bg-gray-800 rounded-full
                flex items-center justify-center">
